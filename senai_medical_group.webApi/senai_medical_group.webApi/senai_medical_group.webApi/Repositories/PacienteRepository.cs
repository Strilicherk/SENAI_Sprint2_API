...
namespace senai_medical_group.webApi.Repositories
{
    public class PacienteRepository : IPacienteRepository
    {
        ...
        /// <summary>
        /// Lista todos os pacientes e as suas consultas
        /// </summary>
        /// <returns>Uma lista de pacientes com suas consultas</returns>
        public List<Paciente> ListarMinhas(int id)
        {
            var pacienteBuscado = ctx.Pacientes
